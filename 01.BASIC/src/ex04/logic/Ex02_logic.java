...
public class Ex02_logic {
	...
	public static void main(String[] args) {
		...
		// 논리 연산
		// 1. && : 논리 AND, 2개 이상의 크기 비교에서 사용,
		// 모든 비교 결과가 true이면 &&의 결과가 true
		// 2. || : 논리 OR, 2개 이상의 크기 비교에서 사용,
		// 하나 이상의 비교 결과가 true이면 ||의 결과가 true
		...
		boolean res8 = (a == 90 && ++b > 10); //순서가 중요
		System.out.println(res8);
		System.out.println(b); //연산을 안해서 10 그대로 값이 나옴.
		
		// ||연산은 ture가 발생하면 더 이상 연산을 진행하지 않는다.
